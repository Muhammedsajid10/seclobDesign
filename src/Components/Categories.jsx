...
//                 <Row>
//                     <Col xs={12} md={6}>
                        // <h4 className="mb-4 mt-5 ml-5">Categories</h4>
//                         <ul className='uList'>
//                             <li>Adventure </li>
//                             <li>Culinary</li>
//                             <li>Eco-Tourism</li>
        ...
        <div className='Cate w-full mt-16 sm:mt-0'>
            <Container>
                <Row>
                    ...
                    <h4 className="mb-4 mt-5 ml-5">Categories</h4>
                        <div className='space-y-4'>
                            {categories.map((category, index) => (
                                <div 
                                    key={index} 
                                    className="d-flex justify-content-between align-items-center bg-light p-4 rounded shadow-sm cursor-pointer   customCate">
                    ...
                    <Col xs={12} md={6}>
                        <h4 className="mb-4 mt-5 ">Travel Guide</h4>
                        <div className='d-flex flex-row justify-content-between carrd'>
                            <div className="guide1">
                                <h2>Muhammad Sajid</h2>
                                <p>Guide since 2015</p>
                                <Button variant="outline-primary">Primary</Button>
